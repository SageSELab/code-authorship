...
tree_sitter_paths = {
    'cpp': './tree-sitter-so/tree-sitter-cpp.so',
    'python': './tree-sitter-so/tree-sitter-python.so',
    'java': './tree-sitter-so/tree-sitter-java.so',
    'javascript': './tree-sitter-so/tree-sitter-javascript.so',
    'csharp': './tree-sitter-so/tree-sitter-c-sharp.so',
    'ruby': './tree-sitter-so/tree-sitter-ruby.so'
}
...
def get_parser(language):
    """ Initializes and returns a Tree-sitter parser for a given language. """
    LANGUAGE = Language(tree_sitter_paths[language], lanaguage_mapping[language])
    parser = Parser()
...
def find_code_snippet(location):
    ...
    sample_df = pd.read_csv(f"../LeetCode/data/fold_{fold}_test.csv")
...
if __name__ == '__main__':
    ...
    for index, row in df.iterrows():
        ...
        try:
            if rule == 0:
                result = check_rule_0(original_code, adversarial_code, language)
            elif rule == 1:
                result = check_rule_1(original_code, adversarial_code, language) and are_comments_equal(original_code, adversarial_code, language)
            elif rule == 2:
                result = check_rule_2(original_code, adversarial_code, language) and are_comments_equal(original_code, adversarial_code, language)
            elif rule == 3:
                result = check_rule_3(original_code, adversarial_code, language) and are_comments_equal(original_code, adversarial_code, language)
            elif rule == 4:
                #Count number of statements
                result = check_rule_4(original_code, adversarial_code, language) and are_comments_equal(original_code, adversarial_code, language)
            elif rule == 5:
                result = check_rule_5(original_code, adversarial_code, language) and are_comments_equal(original_code, adversarial_code, language)
            elif rule == 6:
                result = check_rule6_and_7(original_code, adversarial_code, language) and are_comments_equal(original_code, adversarial_code, language)
            elif rule == 7:
                result = check_rule6_and_7(original_code, adversarial_code, language) and are_comments_equal(original_code, adversarial_code, language)
            elif rule == 8:
                result = check_rule_8(original_code, adversarial_code, language) and are_comments_equal(original_code, adversarial_code, language)
            elif rule == 9:
                result = check_rule_9(original_code, adversarial_code, language) and are_comments_equal(original_code, adversarial_code, language)
            elif rule == 10:    
                result = check_rule_10(original_code, adversarial_code, language) and are_comments_equal(original_code, adversarial_code, language)
            elif rule == 11:
                result = check_rule_11(original_code, adversarial_code, language) and are_comments_equal(original_code, adversarial_code, language)
            elif rule == 12:
                result = check_rule_12(original_code, adversarial_code, language) and are_comments_equal(original_code, adversarial_code, language)
            elif rule == 13:
                result = check_rule_13(original_code, adversarial_code, language) and are_comments_equal(original_code, adversarial_code, language)
            elif rule == 14:
                result = check_rule_14(original_code, adversarial_code, language) and are_comments_equal(original_code, adversarial_code, language)
            elif rule == 15:
                result = check_rule_15(original_code, adversarial_code, language) and are_comments_equal(original_code, adversarial_code, language)
            elif rule == 16:
                result = check_rule_16(original_code, adversarial_code, language) and are_comments_equal(original_code, adversarial_code, language)
            elif rule == 17 or rule == 18:
                result = check_rule_17_and_18(original_code, adversarial_code, language) and are_comments_equal(original_code, adversarial_code, language)
            elif rule == 19 or rule == 20:
                result = check_rule_19_and_20(original_code, adversarial_code, language) and are_comments_equal(original_code, adversarial_code, language)
            elif rule == 21:
                result = check_rule_21(original_code, adversarial_code, language) and are_comments_equal(original_code, adversarial_code, language)
            elif rule == 22:
                #Not working for ternary operators
                result = check_rule_22(original_code, adversarial_code, language) and are_comments_equal(original_code, adversarial_code, language)
            elif rule == 23:
                result = check_rule_23(original_code, adversarial_code, language) and are_comments_equal(original_code, adversarial_code, language)
            elif rule == 24:
                result = check_rule_24(original_code, adversarial_code, language)  and are_comments_equal(original_code, adversarial_code, language)
            elif rule == 25:
                result = check_rule_25(original_code, adversarial_code, language) and are_comments_equal(original_code, adversarial_code, language)
            elif rule == 26:
                result = check_rule_26(original_code, adversarial_code, language) and are_comments_equal(original_code, adversarial_code, language)
            elif rule == 27:
                result = check_rule_27(original_code, adversarial_code, language) and are_comments_equal(original_code, adversarial_code, language)
            else:
                result = False
            ...
            if not os.path.exists(f"./Invalid-Transformations/{rule}"):
                os.mkdir(f"./Invalid-Transformations/{rule}")
            
            if result == False:
                with open(f"./Invalid-Transformations/{rule}/{location}-{rule}.md", "w") as f:
                    f.write(f"Original Code:\n ```{language}\n{original_code}```\n")
                    f.write(f"Adversarial Code:\n ```{language}\n{adversarial_code}```\n")    
        except Exception as e:
            print(f"Error processing rule {rule} for location {location}: {e}")
            print(f"Original Code:\n{original_code}\n")
            print(f"Adversarial Code:\n{adversarial_code}\n")
            break      
    df.to_csv("../adversarial_samples_GPT4_accepted_verified.csv", index=False)