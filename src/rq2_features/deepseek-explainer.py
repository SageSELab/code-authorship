...
from common.attn_backend import attn_implementation

os.makedirs('explanations', exist_ok=True)

start = time.time()
parser = argparse.ArgumentParser(description='Interpret Predictions')
parser.add_argument('--tokenizer', type=str, default="deepseek-ai/deepseek-coder-1.3b-instruct")
...
for fold in range(0, no_of_folds):
    ...
    for index, row in result_df.iterrows():
        ...
        for ratio in ratios:
            ...
            score[f"{ratio}"] = {"PPLCR": PPLCR, "PPLA": PPLA, "PP": probability_perturb, "PPR": probability_perturb_retain, "OP": probability_original}
