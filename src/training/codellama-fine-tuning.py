...
# --------------------
# Construct LoRA Config with tuned parameters
# --------------------
...
# --------------------
config_df = pd.read_csv(CONFIG_DIR / "hyperparameter_combinations.csv")
...
peft_model.save_pretrained(f'./models/{h_config_no}_{fold}_loramodel')
