...
# 1. TREE-SITTER SETUP
# ----------------------------------------------------------------------------
# Build the Python grammar library (only needed if you haven't built it before).
# If it's already built, you may comment this out or move it elsewhere.
...
# LANGUAGE = Language('tree-sitter-cpp/tree-sitter-cpp.so', 'cpp')
# parser = Parser()
# parser.set_language(LANGUAGE)

tree_sitter_paths = {
    'c++': './tree-sitter-cpp/tree-sitter-cpp.so',
    'python': './tree-sitter-python/tree-sitter-python.so',
    'java': './tree-sitter-java/tree-sitter-java.so',
    'javascript': './tree-sitter-javascript/tree-sitter-javascript.so',
    'c#': './tree-sitter-c-sharp/tree-sitter-c-sharp.so',
    'ruby': './tree-sitter-ruby/tree-sitter-ruby.so'
}
